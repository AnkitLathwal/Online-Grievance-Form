...
<body>
    <div class="container mt-5 w-100" style="margin-right:25px">
   <h2  style="text-align:center;color:darkblue; font-size:50px" class=" mb-4 ">Online Grievance Form</h2>
        <form asp-action="Submit" style="margin-left:70px"  method="post">
            <!-- Row 1 -->
            <div   class="row mb-3" style="width:82%;">
                <div class="col-md-6">
            ...
            <!-- Row 2 -->
            <div style="width:82%" class="row mb-3">
                <div class="col-md-6">
